...
export default function Faq() {
    return (
        <div className={styles.faq}>
            ...
            <p className={styles.faq__paragraph}>Our lazer engraving only works on flat, digitized images. View below examples of what does and what doesn't work.</p>
            <h4 className={styles.faq__title}>Examples of what works</h4>
            <div>
                <Image src={Works1} width="200" height="200"></Image>
                <Image src={Works2} width="200" height="200"></Image>
                <Image src={Works3} width="200" height="200"></Image>
                <Image src={Works4} width="200" height="200"></Image>
                <Image src={Works5} width="200" height="200"></Image>
            </div>
            <h4 className={styles.faq__title}>Examples of what doesn't work</h4>
            <div>
                <Image src={WontWork1} width="200" height="200"></Image>
                <Image src={WontWork2} width="200" height="200"></Image>
            </div>
